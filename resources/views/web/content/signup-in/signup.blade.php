           ...
           <div class=" w-full flex justify-center mt-5 relative  ">
               <div class="w-2/5   ">
                   <div class="border border-gray-300 flex justify-around w-full font-normal h-12 ">
                       <a href="{{route('shop.account')}}" class=" w-full flex justify-center items-center text-gray-400 hover:text-amber-400 border-r border-gray-300 "> ĐĂNG NHẬP</a>
                   ...
                   <form action="{{route('shop.register')}}" method="POST" class="p-5 w-full  border-gray-300 border">
                       @csrf
                       <div class=" w-full">
                           <label for="name" class=" font-bold"> HỌ VÀ TÊN </label> <br>
                           <input type="text"  class="w-full focus:ring-0 border-gray-300 mt-1" name="name" id="name" placeholder="Nhập họ và tên ..">
                       </div>
                       <div class=" w-full mt-5">
                           <label for="phone" class=" font-bold"> SỐ ĐIỆN THOẠI </label> <br>
                           <input type="tel"  class="w-full focus:ring-0 border-gray-300 mt-1" name="phone" id="phone" placeholder="Nhập số điện thoai ..." required>
                       </div>
                       <div class=" w-full mt-5">
                           <label for="email" class=" font-bold"> EMAIL </label> <br>
                           <input type="email"  class="w-full focus:ring-0 border-gray-300 mt-1" name="email" id="email" placeholder="Nhập địa chỉ Email .." required>
                           @error('email')
                       ...
                       <div class="w-full mt-5">
                           ...
                           <input type="password" class="w-full focus:ring-0 border-gray-300 mt-1" id="password" name="password" placeholder="Nhập mật khẩu .." required>
                       </div>

                       <button type="submit" class=" w-full flex justify-center bg-blue-500 text-white p-2 font-bold mt-3" > TẠO TÀI KHOẢN</button>
                   </form>
               </div>
           </div>
