...
@section('title','Tin tức | Shoponline.th')
@section('content')
    <div class="w-full h-full">
        <div style="background-image: url('{{asset('images/bg-breadcrumb.webp')}}')" class=" w-full h-[200px] bg-cover flex items-center justify-center">
            <div class=" block text-center">
                <h2 class="font-bold text-2xl"> Tin tức</h2>
                <span class="block mt-5 text-sm">
                    <span> <a href="{{route('shop.index')}}" class="hover:text-amber-400"> Trang chủ</a> /  <strong>  Tư vấn cách chọn hoa quả </strong> </span>
                </span>
            </div>
        </div>
