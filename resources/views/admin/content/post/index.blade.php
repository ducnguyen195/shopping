        ...
        <div class="block justify-between items-center p-4 mx-4 mt-4 mb-4 bg-white rounded-2xl shadow-xl shadow-gray-200 lg:p-5 sm:flex">
            <div class="mb-1 w-full">
                <div class="mb-4">
                    ...
                    <h1 class="text-xl font-semibold text-gray-900 sm:text-2xl">All Post</h1>
                        ...
                        <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                            ...
                            @foreach($post as $item)
                                <tr class="hover:bg-gray-100">
                                    ...
                                    <td class="p-4 text-base font-normal text-gray-900 whitespace-nowrap lg:p-5">{{$item ->viewer}}</td>
                                    <td class="p-4 text-base font-normal text-gray-900 whitespace-nowrap lg:p-5">{{$item ->rating_number}}</td>
                                    <td class="p-4 text-base font-normal text-gray-900 whitespace-nowrap lg:p-5">{{$item ->rating_value}}</td>
                                    <td class="p-4 text-base font-normal text-gray-900 whitespace-nowrap lg:p-5">{!! $item ->seo_description !!}</td>
                                    <td class="p-4 text-base font-normal text-gray-900 whitespace-nowrap lg:p-5">{{$item ->seo_title}}</td>
                                    <td class="p-4 text-base font-normal text-gray-900 whitespace-nowrap lg:p-5">{{$item ->seo_keyword}}</td>
                                    <td class="p-4 space-x-2 whitespace-nowrap lg:p-5">
                                        <a href="{{route('admin.edit_post',$item->id)}}">
                                    ...
                                    <div class="relative px-4 w-full max-w-md h-full md:h-auto">
                                        <div class="relative bg-white rounded-2xl shadow-lg">
                                            ...
                                            <div class="p-6 pt-0 text-center">
                                                ...
                                                <a href="{{route('admin.destroy_post',$item->id)}}" class="text-white bg-gradient-to-br from-red-400 to-red-600 font-medium rounded-lg text-base inline-flex items-center px-3 py-2.5 text-center mr-2 shadow-md shadow-gray-300 hover:scale-[1.02] transition-transform">
                                                    Yes, I'm sure
                                                </a>
