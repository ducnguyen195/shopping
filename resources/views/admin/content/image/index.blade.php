                        ...
                        <tr class="hover:bg-gray-100">
                            ...
                            <td class="p-4 space-x-2 whitespace-nowrap lg:p-5">
                                <a href="{{route('admin.edit_image',[$type,$item->id])}}">
                                    <button type="button" title="Sửa" data-modal-target="edit-brand-modal" data-modal-toggle="edit-brand-modal"
                                ...
                                <a href="#">
                                    <button type="button" title="Xóa" data-modal-target="delete-image-modal-{{$item->id}}" data-modal-toggle="delete-image-modal-{{$item->id}}" class="inline-flex items-center py-2 px-3 text-sm font-medium text-center text-white bg-gradient-to-br from-red-500 to-red-600 rounded-lg shadow-md shadow-gray-300 hover:scale-[1.02] transition-transform">
