                ...
                <ol class="inline-flex items-center space-x-1 md:space-x-2">
                    ...
                    <li>
                        <div class="flex items-center">
                            ...
                            <a href="#" class="ml-1 text-sm font-medium text-gray-700 hover:text-gray-900 md:ml-2">Category</a>
                        </div>
                    </li>
                    <li>
                        <div class="flex items-center">
                            <svg class="w-6 h-6 text-gray-400" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z" clip-rule="evenodd"></path></svg>
                            <span class="ml-1 text-sm font-medium text-gray-400 md:ml-2" aria-current="page">Add {{$model_type}}</span>
                        </div>
                    </li>
                </ol>
            </nav>
            <div>
                <h2 class="font-bold text-2xl"> Add new {{$model_type}}</h2>
            </div>

        </div>
        <div class="m-5 p-5 grid grid-cols-3 gap-4 " >
            <form action="{{route('admin.store_category',$model_type)}}"  method="POST"  class="w-full col-span-2 self-center rounded-2xl shadow-lg shadow-gray-200 bg-white " >
                @csrf
                <div class=" mt-5 gap-4 px-10 ">
                    ...
                    <div class=" mt-5" >
                        <label for="add_slug" class="block mb-2 font-medium text-gray-600"> Model Type</label>
                        <input type="text" id="add_slug" name="slug" class=" rounded-lg outline-violet-300 w-full " value="{{$model_type}}" >
                    </div>
                    <div class="mt-5" >
