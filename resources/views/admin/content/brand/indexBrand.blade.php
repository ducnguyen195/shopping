    ...
    <div class="block justify-between items-center p-4 mx-4 mt-4 mb-4 bg-white rounded-2xl shadow-xl shadow-gray-200 lg:p-5 sm:flex">
        <div class="mb-1 w-full">
            <div class="mb-4">
                ...
                <h1 class="text-xl font-semibold text-gray-900 sm:text-2xl">All Brand</h1>
...
{{--                                <img class="w-8 h-8 rounded" src="https://demos.creative-tim.com/soft-ui-flowbite-pro/images/users/neil-sims.png" alt="Neil Sims avatar">--}}
                            ...
                            <td class="p-4 text-base font-medium text-gray-900 whitespace-nowrap lg:p-5">{{$item -> slug}}</td>
                            <td class="p-4 text-base font-medium text-gray-900 whitespace-nowrap lg:p-5">{{$item -> id}}</td>
                            <td class="p-4 text-base font-normal text-gray-900 whitespace-nowrap lg:p-5">{{$item ->description}}</td>
                            <td class="p-4 space-x-2 whitespace-nowrap lg:p-5">
                                <a href="{{route('admin.edit_brand',$item ->id)}}">
    ...
    {{--  Modal delete--}}
{{--    <div class="hidden overflow-y-auto overflow-x-hidden fixed right-0 left-0 top-4 z-50 justify-center items-center md:inset-0 h-modal sm:h-full" id="delete-brand-modal" aria-hidden="true">--}}
{{--        <div class="relative px-4 w-full max-w-md h-full md:h-auto">--}}
{{--            <div class="relative bg-white rounded-2xl shadow-lg">--}}
{{--                <div class="flex justify-end p-2">--}}
{{--                    <button type="button" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-2xl text-sm p-1.5 ml-auto inline-flex items-center" data-modal-toggle="delete-brand-modal">--}}
...
{{--                        Yes, I'm sure--}}
{{--                    </a>--}}
{{--                    <a href="#" class="text-gray-900 bg-white hover:bg-gray-100 border border-gray-200 font-medium inline-flex items-center rounded-lg text-base px-3 py-2.5 text-center hover:scale-[1.02] transition-transform" data-modal-toggle="delete-brand-modal">--}}
{{--                        No, cancel--}}
{{--                    </a>--}}
{{--                </div>--}}
{{--            </div>--}}
