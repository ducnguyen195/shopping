                        ...
                        <table class="min-w-full divide-y divide-gray-200 table-fixed">
                            ...
                            @foreach($shops as $item)
                                <tr class="hover:bg-gray-100">
                                    ...
                                    <td class="p-4 text-sm font-normal text-gray-900 whitespace-nowrap lg:p-5">{{$item -> name}}</td>
                                    <td class="p-4 text-sm font-normal text-gray-900 whitespace-nowrap lg:p-5">{{$item -> address}}</td>
                                    <td class="p-4 text-sm font-normal text-gray-900 whitespace-nowrap lg:p-5">{{$item -> phone}}</td>
