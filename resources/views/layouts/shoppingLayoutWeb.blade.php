   ...
   <div class="w-full relative ">
       <div class="bg-[#3ba66b] w-ful h-full flex justify-around py-2 ">
           <div class="flex self-center">
               <ul class="text-white text-[16px] font-normal flex  gap-5 ">
                   ...
                   <li class="hover:text-amber-400">
                       <a href="{{route('shop.introduce')}}"> Giới Thiệu </a>
                   </li>
                   <li class="hover:text-amber-400">
                       <a href="{{route('shop.blog')}}"> Blog </a>
                   </li>
                   <li class="hover:text-amber-400">
           ...
           <div class="flex self-center gap-6 items-center ">
               <div >
                   <form action="" class="relative ">
                       ...
                       <input type="text" id="search" name="search_product" class="rounded-full p-3 outline-none w-60" placeholder="Bạn cần tìm gì ?">
               ...
               <div>
                   <div class="text-white text-2xl relative" >
                       <a href="{{route('shop.favourite')}}" title="Sản phẩm yêu thích">
                           <i class="fa-solid fa-heart"> </i>
                       </a>
                       <div class="absolute top-0 left-7 text-xs w-4 h-4 bg-amber-400 rounded-full flex justify-center">
                            <p class="" id="quantity_favourite"> 0 </p>
                       </div>
                   </div>
               </div>
               <div>
                   <div class="text-white text-2xl relative">
                       <button type="button" id="view-cart" data-modal-toggle="cart_body"  data-modal-target="cart_body" title="Giỏ hàng"  >
                           <i class="fa-solid fa-bag-shopping"> </i>
                       </button>
                       <div class="absolute top-0 left-6 text-xs w-4 h-4 bg-amber-400 rounded-full flex justify-center">
                           <p class="" id="quantity_cart" > 0 </p>
                       </div>
                   </div>
               </div>
                               ...
                               <div class=" h-full " >
                                   @guest
                                       <div class=" w-full py-1 border-b">
                                           <a href="{{route('shop.login_form')}}" class="mt-2 text-black"> Đăng Nhập</a>
                                       </div>
                                       <div class="py-1">
                                   ...
                                   @else
                                       <div class=" w-full py-1 border-b">
                                           <a href="{{route('shop.account')}}" class="mt-2"> {{ Auth::user()->name }}</a>
                                       </div>
    ...
    <div id="scroll_bar" class="grid gap-1  fixed bottom-40 right-2 z-40 " >
        ...
        <div class="shadow-lg rounded-full">
            <a href=""  title="Chat với chúng tôi qua Zalo">
        ...
        <div class="text-white text-2xl bg-cyan-300 w-11 h-11 rounded-full flex justify-center items-center shadow-lg">
            <a href="" title="Gửi Email cho chúng tôi"> <i class="fa-solid fa-envelope"></i></a>
        </div>
        <div class="text-white  text-2xl bg-yellow-400 w-11 h-11 rounded-full flex justify-center items-center shadow-lg ">
            <a href="" title="Hệ thống cửa hàng"><i class="fa-solid fa-location-dot"></i></a>
        </div>
    </div>
    {{--    FOOTER  --}}
    <div class="w-full h-full mt-8 relative bg-[#3ba66b] ">
        <div class=" mt-6 pb-8 " >
            <img src="{{asset('images/bg-footer.png')}}" alt="" class="absolute  -top-12 h-12">
        </div>
        {{--   FOOTER 1  --}}
        <div class="bg-[#3ba66b] font-normal text-white  text-center ">
            <div class="w-full px-32 py-4 pb-9 grid grid-cols-3 gap-20 items-center ">
                {{--  Block 1  --}}
                <div class="  mt-10 ">
                    <div class="" >
                        <div class="" >
                            <h3 class="font-bold"> ĐĂNG KÝ NHẬN THÔNG TIN </h3>
                            <p class="mt-7 text-sm block"> Đăng ký nhận bản tin để nhận ưu đãi đặc biệt về sản phẩm </p>
                        </div>
                        <div  class=" w-full  flex justify-center mt-5">
                            <form action="" class="flex relative w-2/3" >
                                <label for="input-introduction"></label>
                                <input type="tel" id="input-introduction" class="text-black rounded-full p-2.5 outline-none  w-full" placeholder="Nhập số điện thoại">
                                <div class=" h-full  w-1/3 absolute top-0 right-0 bg-amber-300 rounded-r-full font-bold text-sm flex justify-center items-center" >
                    ...
                    <div class="mt-10">
                        <ul class="text-sm ">
                            <li>
                                <a href="" class="mt-2 block"> Chính sách thanh toán </a>
                            </li>
                            <li>
                                <a href="" class="mt-2 block"> Chính sách bảo mật </a>
                            </li>
                            <li>
                                <a href=""  class="mt-2 block"> Chính sách vận chuyển</a>
                            </li>
                            <li>
                                <a href=""  class="mt-2 block"> Chính sách đổi trả</a>
                            </li>
                            <li>
                                <a href=""  class="mt-2 block"> Chính sách kiểm hàng</a>
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="mt-10 text-center">
                    ...
                    <div class="text-sm mt-7">
                        <p class="mt-1 "> Hộ kinh doanh: Trái cây nhập khẩu</p>
                        <p class="mt-1"> MST 01B8011843 Do UBND quận Tây Hồ cấp ngày 14/03/2017</p>
                    </div>
                    <div>
                        <ul class=" ">
                            <li class="flex justify-center text-center mt-1 text-[14px]">
                                <span>
                                <strong> Địa chỉ 1 :</strong>
                                    Số 95 Xuân La - Tây Hồ - Hà Nội
                                </span>

                            </li>
                            <li class="flex  justify-center mt-1 text-sm">
                               <span>
                                   <strong> Địa chỉ 2 : </strong>
                                   Số 97 Đào Tấn - Ba Đình - Hà Nội
                               </span>
                            </li>
                            <li  class="flex  justify-center mt-1 text-sm">
                              <span>
                              <strong> Địa chỉ 3 : </strong>
                                  Số 24B7 Phạm Ngọc Thạch - Đống Đa - HN
                              </span>
                            </li>
                            <li class="flex  justify-center mt-1 text-sm">
                                <span>
                                    <strong> Địa chỉ 4 : </strong>
                                    20 Tràng Thi- Hàng Trống- Hoàn Kiếm HN
                                </span>
                            </li>
                            <li class="flex  justify-center text-center mt-1 text-sm ">
                                <span>
                                    <strong> Địa chỉ 5 : </strong>
                                     45 P. Chùa Láng, Láng Thượng, Đống Đa, Hà Nội
                                </span>
                            </li>
                            <li class="flex  justify-center text-sm mt-1">
                                <span>
...
@include('web.component.add_product')
@include('partial.featureJsWeb')
@include('web.component.getQuantity')
