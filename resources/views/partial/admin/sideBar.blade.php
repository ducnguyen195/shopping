            ...
            <div class="flex-1 px-3 bg-gray-50" id="sidebar-items">
                <ul class="pb-2 pt-1">
                    ...
                    <li>
                        <a href="#" class="flex items-center py-2.5 px-4 text-base font-normal text-dark-500 rounded-lg hover:bg-gray-200  group transition-all duration-200" sidebar-toggle-collapse="">
                            <div class="bg-white shadow-lg shadow-gray-300  text-dark-700 w-8 h-8 p-2.5 mr-1 rounded-lg text-center grid place-items-center">
                                <svg class=" text-dark" fill="currentColor" width="16px" height="16px" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <li>
                        <button type="button" class="w-full flex items-center py-2.5 px-4 text-base font-normal text-dark-500 rounded-lg hover:bg-gray-200  group transition-all duration-200" sidebar-toggle-collapse="" aria-controls="dropdown-pages" data-collapse-toggle="dropdown-pages">
                            <div class="bg-white shadow-lg shadow-gray-300  text-dark-700 w-8 h-8 p-2.5 mr-1 rounded-lg text-center grid place-items-center">
                        ...
                        <ul id="dropdown-pages" sidebar-toggle-list="" class="pb-2 pt-1 hidden ">
                            <li>
                                <a href="https://demos.creative-tim.com/soft-ui-flowbite-pro/pages/pricing/" class="text-sm text-dark-500 font-light rounded-lg flex items-center p-2 group  hover:bg-gray-200 transition duration-75 pl-11">
                                    <span>Pricing</span>
                                    <span class="hidden">P</span>
                                </a>
                            </li>
                    ...
                    <li>
                        <button type="button" class="w-full flex items-center py-2.5 px-4 text-base font-normal text-dark-500 rounded-lg hover:bg-gray-200  group transition-all duration-200" sidebar-toggle-collapse="" aria-controls="dropdown-auth" data-collapse-toggle="dropdown-auth">
                            <div class="bg-white shadow-lg shadow-gray-300  text-dark-700 w-8 h-8 p-2.5 mr-1 rounded-lg text-center grid place-items-center">
                                <svg width="12px" height="12px" viewBox="0 0 40 40" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                            ...
                            <span class="ml-3 text-dark-500 text-sm font-light" sidebar-toggle-item="">Authentication</span>
                ...
                <div class="pt-2">
                    <a href="#" target="_blank" class="flex items-center py-2.5 px-4 text-base font-normal text-dark-500 rounded-lg hover:bg-gray-200 group transition-all duration-200" sidebar-toggle-collapse="">
                        <div class="bg-white shadow-lg shadow-gray-300 text-dark-700 w-8 h-8 p-2.5 mr-1 rounded-lg text-center grid place-items-center">
                        ...
                        <span class="ml-3 text-dark-500 text-sm font-light" sidebar-toggle-item="">Buy now</span>
                    </a>
                    <a href="#" target="_blank" class="flex items-center py-2.5 px-4 text-base font-normal text-dark-500 rounded-lg hover:bg-gray-200 group transition-all duration-200" sidebar-toggle-collapse="">
                        <div class="bg-white shadow-lg shadow-gray-300 text-dark-700 w-8 h-8 p-2.5 mr-1 rounded-lg text-center grid place-items-center">
                            <svg class="text-dark mb-1" width="12px" height="12px" viewBox="0 0 40 44" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                                <title>document</title>
                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                    <g transform="translate(-1870.000000, -591.000000)" fill="currentColor" fill-rule="nonzero">
                                        <g transform="translate(1716.000000, 291.000000)">
